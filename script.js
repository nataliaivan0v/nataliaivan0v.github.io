...
const RUNS = {
  ...
  ledger: [
    ['prompt','$ '],['cmd','ledger analyze NVDA\n'],
    ['dim','[prices] 6mo daily OHLCV via yfinance ......... 124 days\n'],
    ['dim','[signal] recent 5d move +8.28% ('],['amber','3.4σ'],['dim',') + bearish 20/50 MA cross → '],['amber','unusual\n'],
    ['dim','[round 1] 4 queries → retrieve 16 chunks\n'],
    ['dim','[grade] sufficient? '],['green','no '],['dim','— only 10-Q boilerplate, no dated catalyst\n'],
    ['dim','[round 2] 4 queries → retrieve 23 chunks\n'],
    ['dim','[grade] sufficient? '],['green','no '],['dim','— still no news tied to the move\n'],
    ['dim','[round 3] 4 queries → retrieve 27 chunks\n'],
    ['dim','[grade] sufficient? '],['green','no '],['dim','— max rounds, synthesize on best evidence\n'],
    ['dim','[synthesize] stance HOLD · 5 why claims (attempt 1)\n'],
    ['dim','[verify] citation gate ......... 1/5 sourced → retry\n'],
    ['dim','[synthesize] regrounding claims (attempt 2)\n'],
    ['dim','[verify] citation gate ......... '],['green','2/5 sourced ✓\n'],
    ['dim','[benchmark] buy-and-hold +14.21% / 124d (~+31.0% annualized)\n'],
    ['amber','\n▸ NVDA — Grounded Briefing\n\n'],
    ['cmd','  What happened: +8.28% over 5 days (~3.4σ), yet a\n  bearish 20/50-day MA crossover formed alongside the gain.\n\n'],
    ['cmd','  Stance: '],['amber','HOLD '],['cmd','(vs buy-and-hold +14.21% over window)\n\n'],
    ['cmd','  Why (grounded in sources)\n'],
    ['cmd','  • Gross margin rose YoY on lower inventory provisions\n    vs the prior $4.5B H20 charge; Blackwell still most of\n    revenue '],['dim','[S12 · 10-Q]'],['cmd','.\n'],
    ['cmd','  • No discrete catalyst dated to the move was found;\n    evidence is fundamental, not a window event '],['dim','[S7,S8,S12,S20]'],['cmd','.\n\n'],
    ['green','  3 claims dropped — no evidence found · 4 sources cited\n'],
